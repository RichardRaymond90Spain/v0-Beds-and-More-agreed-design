...
export function CTAButtons({ productName, productType = "product", variant = "default", className = "" }: CTAButtonsProps) {
  const whatsappMessage = productName
    ? `Hi, I'm interested in the ${productName}. Can you provide more information?`
    : `Hi, I'd like to enquire about your ${productType}s.`
...
export function MobileCTABar({ productName, productType = "product" }: { productName?: string; productType?: string }) {
  const whatsappMessage = productName
    ? `Hi, I'm interested in the ${productName}. Can you provide more information?`
    : `Hi, I'd like to enquire about your ${productType}s.`
