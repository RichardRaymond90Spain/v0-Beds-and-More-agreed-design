...
import { getHeadboardProductBySlug, getHeadboardBrandBySlug } from "@/data/headboards"
...
export default function HeadboardProductPage() {
  const params = useParams()
  const brandSlug = params.brand as string
  const productSlug = params.slug as string
  
  const brand = getHeadboardBrandBySlug(brandSlug)
  const product = getHeadboardProductBySlug(brandSlug, productSlug)
  ...
  return (
    <div className="flex min-h-screen flex-col pb-20 lg:pb-0">
        ...
        <div className="bg-muted/30 border-b">
          <div className="container mx-auto px-4 py-3">
            <nav className="flex items-center text-sm text-muted-foreground">
              <Link href="/headboards" className="hover:text-foreground transition-colors">
                Headboards
              </Link>
              <ChevronLeft className="h-4 w-4 mx-2 rotate-180" />
              <Link href={`/headboards/${brandSlug}`} className="hover:text-foreground transition-colors">
                {brand.name}
              </Link>
              <ChevronLeft className="h-4 w-4 mx-2 rotate-180" />
          ...
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div className="space-y-6">
                ...
                {/* CTA Buttons */}
                <CTAButtons productName={productFullName} productType="headboard" />
                ...
                <div className="grid grid-cols-2 gap-4 pt-4 border-t">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="text-sm font-medium">Wide Fabric Choice</p>
                      <p className="text-xs text-muted-foreground">Match your bedroom</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-2">
                    <div className="p-1.5 rounded-full bg-green-100">
        ...
        <section className="py-12 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              {product.description && (
                <div className="mb-12">
                  <h2 className="font-serif text-2xl font-bold mb-4">About This Headboard</h2>
                ...
                <div className="bg-background rounded-lg border p-6 space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Not happy with your purchase? Exchange it within 14 days for another model. 
                        We want you to love your new headboard.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <Footer />
      <MobileCTABar productName={productFullName} productType="headboard" />
    </div>
  )
}
