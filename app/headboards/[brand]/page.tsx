...
import { getHeadboardBrandBySlug } from "@/data/headboards"
...
export default function HeadboardBrandPage() {
      ...
      <main className="flex-1">
        ...
        <section className="py-8 md:py-12 bg-muted/20">
          <div className="container mx-auto px-4">
            <h1 className="font-serif text-3xl md:text-4xl font-bold">{brand.name} Headboards</h1>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {brand.products.map((product) => {
                ...
                return (
                  <Link 
                    key={product.sku} 
                    href={`/headboards/${brandSlug}/${product.slug}`}
