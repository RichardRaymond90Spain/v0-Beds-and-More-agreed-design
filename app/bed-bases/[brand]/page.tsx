...
import { getBedBaseBrandBySlug } from "@/data/bed-bases"
...
export default function BedBaseBrandPage() {
      ...
      <main className="flex-1">
        ...
        <section className="py-8 md:py-12 bg-muted/20">
          <div className="container mx-auto px-4">
            <h1 className="font-serif text-3xl md:text-4xl font-bold">{brand.name} Bed Bases</h1>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {brand.products.map((product) => {
                ...
                return (
                  <Link 
                    key={product.sku} 
                    href={`/bed-bases/${brandSlug}/${product.slug}`}
