...
import { getBedBaseProductBySlug, getBedBaseBrandBySlug } from "@/data/bed-bases"
...
export default function BedBaseProductPage() {
  const params = useParams()
  const brandSlug = params.brand as string
  const productSlug = params.slug as string
  
  const brand = getBedBaseBrandBySlug(brandSlug)
  const product = getBedBaseProductBySlug(brandSlug, productSlug)
  ...
  return (
    <div className="flex min-h-screen flex-col pb-20 lg:pb-0">
        ...
        <div className="bg-muted/30 border-b">
          <div className="container mx-auto px-4 py-3">
            <nav className="flex items-center text-sm text-muted-foreground">
              <Link href="/bed-bases" className="hover:text-foreground transition-colors">
                Bed Bases
              </Link>
              <ChevronLeft className="h-4 w-4 mx-2 rotate-180" />
              <Link href={`/bed-bases/${brandSlug}`} className="hover:text-foreground transition-colors">
                {brand.name}
              </Link>
              <ChevronLeft className="h-4 w-4 mx-2 rotate-180" />
          ...
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div className="space-y-6">
                ...
                {/* CTA Buttons */}
                <CTAButtons productName={productFullName} productType="bed base" />
                ...
                <div className="grid grid-cols-2 gap-4 pt-4 border-t">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">We&apos;ll take your old bed</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-2">
                    <div className="p-1.5 rounded-full bg-green-100">
        ...
        <section className="py-12 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              {product.description && (
                <div className="mb-12">
                  <h2 className="font-serif text-2xl font-bold mb-4">About This Bed Base</h2>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        ...
                        We want you to love your new bed base.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <Footer />
      <MobileCTABar productName={productFullName} productType="bed base" />
    </div>
  )
}
