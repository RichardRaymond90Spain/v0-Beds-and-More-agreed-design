...
import { getRugBrandBySlug } from "@/data/rugs"
...
export default function RugBrandPage() {
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {brand.products.map((product) => {
                ...
                return (
                  <Link 
                    key={product.sku} 
                    href={`/rugs/${brandSlug}/${product.slug}`}
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      {product.color && (
                        <p className="text-xs text-muted-foreground mt-2">Colours: {product.color}</p>
                      )}
