...
import { ProductGallery } from "@/components/mattresses/product-gallery"
import { SizeSelector } from "@/components/mattresses/size-selector"
import { PriceBlock } from "@/components/mattresses/price-block"
import { CTAButtons, MobileCTABar } from "@/components/mattresses/cta-buttons"
import { getProductBySlug, getBrandBySlug } from "@/data/mattresses"
import Link from "next/link"
import { ChevronLeft, Truck, Shield, Store, RefreshCw, Check } from "lucide-react"
...
export default function ProductPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col pb-20 lg:pb-0">
        ...
        <div className="bg-muted/30 border-b">
          <div className="container mx-auto px-4 py-3">
            <nav className="flex items-center text-sm text-muted-foreground">
              <Link href="/mattresses" className="hover:text-foreground transition-colors">
                Mattresses
              </Link>
              <ChevronLeft className="h-4 w-4 mx-2 rotate-180" />
              <Link href={`/mattresses/${brandSlug}`} className="hover:text-foreground transition-colors">
                {brand.name}
              </Link>
              <ChevronLeft className="h-4 w-4 mx-2 rotate-180" />
        ...
        <section className="py-8 md:py-12">
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
              {/* Gallery */}
              <div>
                <ProductGallery images={product.images} productName={productFullName} />
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Badge variant="outline">{product.comfort}</Badge>
                </div>
                ...
                {selectedSize && (
                  <div className="pt-2">
                    <PriceBlock size={selectedSize} showLabel={false} />
                  </div>
                )}

                {/* CTA Buttons */}
                <CTAButtons productName={productFullName} />
                ...
                <div className="grid grid-cols-2 gap-4 pt-4 border-t">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="text-sm font-medium">No Quibble Exchange</p>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="text-sm font-medium">Free Old Bed Removal</p>
                      <p className="text-xs text-muted-foreground">We&apos;ll take your old mattress</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-2">
                    <div className="p-1.5 rounded-full bg-green-100">
        ...
        <section className="py-12 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              {/* Full Description */}
              <div className="mb-12">
                <h2 className="font-serif text-2xl font-bold mb-4">About This Mattress</h2>
                <p className="text-muted-foreground leading-relaxed">{product.description}</p>
              </div>

              {/* Features */}
              <div className="mb-12">
                <h2 className="font-serif text-2xl font-bold mb-4">What It&apos;s Good For</h2>
              ...
              {/* Delivery Info */}
              <div className="mb-12">
                <h2 className="font-serif text-2xl font-bold mb-4">Delivery & Returns</h2>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Free delivery throughout the Costa del Sol. Estimated delivery time: {product.deliveryTimeToShop}.
                        We&apos;ll contact you to arrange a convenient delivery date.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <RefreshCw className="h-5 w-5 text-accent mt-0.5" />
                    <div>
                      <p className="font-medium">No Quibble Exchange</p>
                      <p className="text-sm text-muted-foreground">
                        Not happy with your mattress? Exchange it within 14 days for another model. 
                        We want you to love your new mattress.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <Footer />
      <MobileCTABar productName={productFullName} />
    </div>
  )
}
