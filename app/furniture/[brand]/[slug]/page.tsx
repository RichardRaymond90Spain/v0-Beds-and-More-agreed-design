...
import { getFurnitureProductBySlug, getFurnitureBrandBySlug } from "@/data/furniture"
...
export default function FurnitureProductPage() {
  ...
  const product = getFurnitureProductBySlug(brandSlug, productSlug)
  ...
  return (
    <div className="flex min-h-screen flex-col pb-20 lg:pb-0">
        ...
        <div className="bg-muted/30 border-b">
          <div className="container mx-auto px-4 py-3">
            <nav className="flex items-center text-sm text-muted-foreground">
              ...
              <Link href={`/furniture/${brandSlug}`} className="hover:text-foreground transition-colors">
                {brand.name}
              </Link>
              <ChevronLeft className="h-4 w-4 mx-2 rotate-180" />
              ...
              <div className="space-y-6">
                ...
                {product.color && (
                  <div className="flex items-center gap-2">
                    <span className="text-sm font-medium">Available Finishes:</span>
                ...
                {hasMultipleSizes ? (
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-muted-foreground">{product.sizes[0].dimensions}</span>
                  </div>
                )}
                ...
                {(selectedSize || product.sizes[0]) && (
                  <div className="pt-2">
                    <PriceBlock size={selectedSize || product.sizes[0]} showLabel={false} />
                  </div>
                )}

                {/* CTA Buttons */}
                <CTAButtons productName={productFullName} productType="furniture" />
                ...
                <div className="grid grid-cols-2 gap-4 pt-4 border-t">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Solid construction</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-2">
                    <div className="p-1.5 rounded-full bg-green-100">
                    ...
                    <div>
                      <p className="text-sm font-medium">Assembly Available</p>
        ...
        <section className="py-12 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              {/* Delivery Info */}
              <div className="mb-12">
                <h2 className="font-serif text-2xl font-bold mb-4">Delivery & Assembly</h2>
                <div className="bg-background rounded-lg border p-6 space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium">Professional Assembly</p>
                      <p className="text-sm text-muted-foreground">
                        Professional assembly is available for an additional fee. 
                        Ask us for details when you contact us.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <Footer />
      <MobileCTABar productName={productFullName} productType="furniture" />
    </div>
  )
}
